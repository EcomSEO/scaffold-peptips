...
export default function ContactPage() {
  return (
    <TrustPageTemplate title="Contact">
      <h2>General</h2>
      <p>
        <strong>hello@peptips.com</strong> — feedback, questions,
        product tips, everything else.
      </p>

      <h2>Corrections</h2>
      <p>
        <strong>corrections@peptips.com</strong> — spotted something
      ...
      <h2>Privacy</h2>
      <p>
        <strong>privacy@peptips.com</strong> — questions about data,
