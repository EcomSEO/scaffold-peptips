...
export const metadata: Metadata = pageMetadata({
  ...
  description: "The terms that govern your use of Peptips.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <TrustPageTemplate title="Terms of Service">
      ...
      <p>
        By accessing peptips.com (&ldquo;the Site&rdquo;), you agree to
        these Terms. If you don&apos;t agree, don&apos;t use the Site.
      </p>

      <h2>1. The Site is informational</h2>
      <p>
        Peptips publishes editorial content about non-toxic living,
      ...
      <p>
        ...
        Peptips or licensed to us. You may share excerpts with
      ...
      <p>
        To the maximum extent permitted by law, Peptips is not liable
      ...
      <h2>10. Contact</h2>
      <p>Questions about these Terms? Email hello@peptips.com.</p>
    </TrustPageTemplate>
  );
}
