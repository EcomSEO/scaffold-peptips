...
export default function PrivacyPage() {
  return (
    <TrustPageTemplate title="Privacy Policy">
      ...
      <p>
        This Privacy Policy describes how Peptips (&ldquo;we,&rdquo;
        &ldquo;us,&rdquo; or &ldquo;our&rdquo;) collects, uses, and shares
        information when you visit peptips.com.
      </p>
      ...
      <p>
        ...
        privacy@peptips.com. We respond within 30 days.
      </p>

      <h2>6. Children</h2>
      <p>
        Peptips is not directed at children under 13. We do not
      ...
      <h2>10. Contact</h2>
      <p>Questions? Email privacy@peptips.com.</p>
    </TrustPageTemplate>
  );
}
