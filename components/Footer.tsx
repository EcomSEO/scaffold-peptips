      ...
      <div className="mx-auto max-w-6xl px-6 pt-14 pb-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 pb-10 border-b border-pine/15">
          ...
          <div className="max-w-md text-sm text-stone leading-relaxed">
            A small team reading the trials, the labels, and the literature —
            publishing what we&apos;d tell a friend. No drug-manufacturer money.
            No telehealth-clinic deals.
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-10 mt-10">
          ...
          <div className="md:col-span-4">
            ...
            <p className="mt-5 text-[12.5px] text-stone leading-relaxed border-t border-pine/10 pt-4">
              ...
              Peptips is an educational resource. Talk to your prescriber
              before changing your GLP-1 regimen. We do not accept money from
              drug manufacturers or telehealth clinics.
            </p>
          </div>
        </div>
      </div>
